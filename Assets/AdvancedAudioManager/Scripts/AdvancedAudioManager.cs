...
public class AdvancedAudioManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            // Make a new GameObject for each of them...
            GameObject _go = new GameObject("Sound_" + i + "_" + sounds[i].name);
            // Make the AdvancedAudioManager each of them's parent in the hierachy...
            _go.transform.SetParent(transform);
            // Make a new AudioSource on their GameObject for each of them...
